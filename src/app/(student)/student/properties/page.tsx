      ...
      <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="text-xs font-bold text-[#005F56] bg-[#005F56]/10 px-2.5 py-0.5 rounded-md border border-[#005F56]/20">
                Accredited Student Housing
              </span>
              <span className="text-xs text-slate-400">•</span>
              <span className="text-xs font-semibold text-slate-500">
                {properties.length} Available Residence{properties.length !== 1 ? "s" : ""}
              </span>
            </div>
            <h1 className="text-2xl font-bold text-slate-900 tracking-tight">
              Explore Student Residences
            </h1>
            <p className="text-xs text-slate-500 mt-0.5">
              Browse verified student communes, apartments, and accredited residences near your university.
            </p>
          </div>
        ...
        {properties.length === 0 ? (
          <div className="p-12 text-center rounded-2xl border-2 border-dashed border-slate-300 bg-white space-y-3">
            ...
            <h3 className="text-base font-bold text-slate-900">No Residences Listed Yet</h3>
            <p className="text-xs text-slate-500 max-w-sm mx-auto">
              Check back soon as accredited landlords list new student accommodation for the upcoming semester.
            </p>
          </div>
        ) : (
          /* Grid of Realistic Property Cards */
